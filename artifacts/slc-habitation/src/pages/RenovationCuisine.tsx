...
` }} />
        ...
        <main className="main-wrapper">
          ...
          <div data-collapse="medium" data-animation="over-left" data-duration="400" fs-scrolldisable-element="smart-nav" data-easing="ease" data-easing2="ease" role="banner" className="navbar3_component color-scheme-1 w-nav">
            ...
            <div className="navbar3_container">
              ...
              <nav id="site-navigation" role="navigation" className="navbar3_menu w-nav-menu">
                ...
                {' '}
                <a href="/formulaire" data-service="renovation-cuisine" className="navbar3_tablet-menu-button w-button">
                  Soumission
                </a>
                {' '}
              </nav>
              ...
              {' '}
              <a id="w-node-e94d028c-b457-e648-e3c9-1bebe5f245fc-e5f245dc" href="/formulaire" data-service="renovation-cuisine" className="button w-button">
                Soumission
              </a>
              {' '}
          ...
          <section className="relative py-20 md:py-28 bg-mine-shaft text-white overflow-hidden">
            ...
            <div className="container-large relative z-10 px-6 max-w-4xl mx-auto text-center fade-up">
              ...
              <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
                Alliez ergonomie, rangement intelligent et design. Nous orchestrons la transformation complète de votre cuisine pour en faire la pièce maîtresse de votre résidence.
              </p>
              {' '}
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                {' '}
                <a href="/formulaire" data-service="renovation-cuisine" className="cta-link !bg-[#f58026] hover:bg-[#d86d1b] transition-colors px-8 py-4 rounded-lg font-medium text-lg w-full sm:w-auto text-white text-center shadow-md">
          ...
          <section className="py-24 bg-white">
            ...
            <div className="container-large px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                {' '}
                <div className="bg-neutral-lightest p-10 rounded-[2rem] border border-neutral-lighter hover:border-[#f58026] transition-colors fade-up">
                  {' '}
                  <div className="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center text-[#f58026] mb-6">
                    {' '}
                ...
                {' '}
                <div className="bg-neutral-lightest p-10 rounded-[2rem] border border-neutral-lighter hover:border-[#f58026] transition-colors fade-up delay-100">
                  {' '}
                  <div className="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center text-[#f58026] mb-6">
                    {' '}
                    <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  {' '}
                  <p className="text-neutral-dark">
                    Ajout d'îlots avec prises intégrées, éclairage encastré, rubans LED sous les armoires et circuits dédiés pour vos électroménagers.
                  </p>
                  {' '}
                </div>
                {' '}
                <div className="bg-neutral-lightest p-10 rounded-[2rem] border border-neutral-lighter hover:border-[#f58026] transition-colors fade-up delay-200">
                  {' '}
                  <div className="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center text-[#f58026] mb-6">
                    {' '}
                    <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="mb-16 fade-up">
                {' '}
                <img src="/images/relume-567906.jpeg" width="1440" height="1440" sizes="(max-width: 1440px) 100vw, 1440px" srcSet="/images/relume-567906-p-500.jpeg 500w, /images/relume-567906-p-800.jpeg 800w, /images/relume-567906-p-1080.jpeg 1080w, /images/relume-567906.jpeg 1440w" loading="lazy" alt="Intérieur résidentiel rénové par SLC Habitation" className="w-full h-[50vh] min-h-[300px] object-cover rounded-[2rem] shadow-xl border-4 border-white" />
                {' '}
              </div>
              {' '}
              <div className="max-w-4xl mx-auto mt-24 bg-neutral-lightest rounded-[2rem] p-10 border border-neutral-lighter fade-up">
                {' '}
                ...
                <div className="space-y-4">
                  ...
                  <details className="group bg-white rounded-xl border border-neutral-lighter">
                    ...
                    <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-5 text-mine-shaft">
                      {' '}
                      <span>
                        Est-ce possible d'abattre un mur pour créer une aire ouverte ?
                      </span>
                      {' '}
                    ...
                    <div className="text-neutral-dark px-5 pb-5 leading-relaxed">
                      {' C\'est souvent possible après avoir déterminé si le mur est porteur. Un ingénieur en structure peut être requis pour concevoir le soutien approprié. '}
                    </div>
                    {' '}
                  </details>
                  {' '}
                  <details className="group bg-white rounded-xl border border-neutral-lighter">
                    ...
                    <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-5 text-mine-shaft">
                      {' '}
                      <span>
                        Doit-on commander les électroménagers avant le début des travaux ?
                      </span>
                      {' '}
                      <span className="transition group-open:rotate-180">
                        {' '}
                    ...
                    {' '}
                    <div className="text-neutral-dark px-5 pb-5 leading-relaxed">
                      {' Il est recommandé de connaître leurs dimensions et leurs spécifications avant les travaux afin de planifier les armoires, prises et raccordements. '}
                    </div>
                    {' '}
                  </details>
                  {' '}
                  <details className="group bg-white rounded-xl border border-neutral-lighter">
                    ...
                    <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-5 text-mine-shaft">
                      {' '}
                      <span>
                        Installez-vous des planchers chauffants dans la cuisine ?
                      </span>
                      {' '}
                      <span className="transition group-open:rotate-180">
                        {' '}
                    ...
                    {' '}
                    <div className="text-neutral-dark px-5 pb-5 leading-relaxed">
                      {' Un plancher chauffant peut être intégré lorsque le système choisi est compatible avec le nouveau revêtement et les conditions d\'installation. '}
                    </div>
                    {' '}
                  </details>
                  {' '}
          ...
          <section className="py-24 bg-neutral-lightest">
            ...
            <div className="container-large px-6">
              {' '}
              <div className="bg-mine-shaft rounded-[3rem] p-10 md:p-16 overflow-hidden relative fade-up">
                {' '}
                <div className="absolute top-0 right-0 w-1/2 h-full opacity-20 hidden md:block">
                  {' '}
                  <img src="/images/relume-655417.jpeg" width="2560" height="1920" sizes="(max-width: 991px) 1px, 50vw" srcSet="/images/relume-655417-p-500.jpeg 500w, /images/relume-655417-p-800.jpeg 800w, /images/relume-655417-p-1080.jpeg 1080w, /images/relume-655417-p-1600.jpeg 1600w, /images/relume-655417-p-2000.jpeg 2000w, /images/relume-655417.jpeg 2560w" loading="lazy" alt="Texture cuisine" className="w-full h-full object-cover" />
                  {' '}
                  <div className="absolute inset-0 bg-gradient-to-l from-transparent to-mine-shaft"></div>
                  {' '}
                </div>
                {' '}
                <div className="relative z-10 max-w-2xl">
                  ...
                  <p className="text-lg text-gray-300 mb-10">
                    Découvrez comment notre approche structurée peut simplifier la coordination de votre rénovation de cuisine.
                  </p>
                  {' '}
                  <a href="/formulaire" data-service="renovation-cuisine" className="cta-link inline-block !bg-[#f58026] hover:bg-[#d86d1b] transition-colors px-10 py-5 rounded-lg font-bold text-lg text-white shadow-xl">
                  ...
                  <div className="w-layout-grid footer3_top-wrapper">
                    ...
                    <div className="w-layout-grid footer3_menu-wrapper">
                      ...
                      <div className="footer3_link-list">
                        ...
                        {' '}
                        <a href="/formulaire" data-service="renovation-cuisine" className="footer3_link">
                          Soumission
                        </a>
                        {' '}
                      </div>
