          ...
          <div data-collapse="medium" data-animation="over-left" data-duration="400" fs-scrolldisable-element="smart-nav" data-easing="ease" data-easing2="ease" role="banner" className="navbar3_component color-scheme-1 w-nav">
            ...
            <div className="navbar3_container">
              ...
              <nav id="site-navigation" role="navigation" className="navbar3_menu w-nav-menu">
                ...
                {' '}
                <a href="/soumission" data-service="renovation-cuisine" className="navbar3_tablet-menu-button w-button">
                  Soumission
                </a>
                {' '}
              </nav>
              ...
              {' '}
              <a id="w-node-e94d028c-b457-e648-e3c9-1bebe5f245fc-e5f245dc" href="/soumission" data-service="renovation-cuisine" className="button w-button">
                Soumission
              </a>
              {' '}
          ...
          <section className="relative py-20 md:py-28 bg-mine-shaft text-white overflow-hidden">
            ...
            <div className="container-large relative z-10 px-6 max-w-4xl mx-auto text-center fade-up">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                {' '}
              <a href="/soumission" data-service="renovation-cuisine" className="cta-link !bg-[#f58026] hover:bg-[#d86d1b] transition-colors px-8 py-4 rounded-lg font-medium text-lg w-full sm:w-auto text-white text-center shadow-md">
            ...
            <div className="container-large px-6">
              ...
              <div className="bg-mine-shaft rounded-[3rem] p-10 md:p-16 overflow-hidden relative fade-up">
                ...
                <div className="relative z-10 max-w-2xl">
                  ...
                  {' '}
                  <a href="/soumission" data-service="renovation-cuisine" className="cta-link inline-block !bg-[#f58026] hover:bg-[#d86d1b] transition-colors px-10 py-5 rounded-lg font-bold text-lg text-white shadow-xl">
                  ...
                  <div className="w-layout-grid footer3_top-wrapper">
                    ...
                    <div className="w-layout-grid footer3_menu-wrapper">
                      ...
                      <div className="footer3_link-list">
                        ...
                        {' '}
                        <a href="/soumission" data-service="renovation-cuisine" className="footer3_link">
                          Soumission
                        </a>
                        {' '}
                      </div>
