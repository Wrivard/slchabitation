 ...
 * Page « / ».
 *
 * Convertie depuis l'export Webflow (`site/index.html`) : même balisage,
...
export default function Home() {
  ...
  useEffect(() => {
    const container = containerRef.current;
    if (!container) return;
    return setupHoverCards(container);
  }, []);
...
` }} />
        ...
        <main className="main-wrapper">
          ...
          <div data-collapse="medium" data-animation="over-left" data-duration="400" fs-scrolldisable-element="smart-nav" data-easing="ease" data-easing2="ease" role="banner" className="navbar3_component color-scheme-1 w-nav">
            ...
            <div className="navbar3_container">
              ...
              <nav id="site-navigation" role="navigation" className="navbar3_menu w-nav-menu">
                ...
                {' '}
                <a href="/" aria-current="page" className="navbar3_link w-nav-link w--current">
                  Accueil
                </a>
                {' '}
              ...
              {' '}
              <a href="/" aria-current="page" className="navbar3_logo-link w-nav-brand w--current">
          ...
          {' '}
          <header className="section_header5 text-color-white color-scheme-3">
            {' '}
            <div className="padding-global">
              {' '}
              <div className="container-large">
                {' '}
                <div className="header5_content">
                  {' '}
                  <div className="padding-section-large">
                    {' '}
                    <div data-reveal-group="" className="max-width-medium">
                      {' '}
                      ...
                      <p className="text-size-medium">
                        SLC Habitation redonne vie aux espaces depuis plus de 25 ans. Nous écoutons, nous construisons, nous livrons des résultats qui durent.
                      </p>
                      {' '}
                      <div className="margin-top margin-medium">
                        ...
                        <div className="button-group">
                          ...
                          {' '}
                          <a href="/realisations" className="button is-secondary is-alternate w-button">
                            Nos Réalisations
                          </a>
                          {' '}
                        </div>
            ...
            <div className="header5_background-image-wrapper">
              ...
              <img sizes="(max-width: 2560px) 100vw, 2560px" srcSet="/images/relume-657269-p-500.jpeg 500w, /images/relume-657269-p-800.jpeg 800w, /images/relume-657269-p-1080.jpeg 1080w, /images/relume-657269-p-1600.jpeg 1600w, /images/relume-657269-p-2000.jpeg 2000w, /images/relume-657269.jpeg 2560w" alt="Maison rénovée par SLC Habitation" src="/images/relume-657269.jpeg" loading="eager" className="header5_background-image" />
              {' '}
            </div>
            {' '}
          </header>
          {' '}
          <section className="section_stats14 color-scheme-1">
            {' '}
            <div className="padding-global">
              {' '}
              <div className="container-large">
                ...
                <div className="padding-section-large">
                  {' '}
                  <div className="stats14_component">
                    {' '}
                    <div className="w-layout-grid stats14_content">
                      {' '}
                      <div data-reveal-group="" id="w-node-df626311-65f5-f7ae-e458-b9664b55ed17-290c3bd4" className="stats14_content-left">
                        {' '}
                        ...
                        <div className="margin-bottom margin-small">
                          ...
                          <h2 className="heading-style-h2">
                            Vingt-cinq ans de travail sans compromis
                          </h2>
                          {' '}
                        </div>
                        {' '}
                        <p className="text-size-medium">
                          SLC Habitation construit sur des bases solides. Depuis le début, nous avons choisi la qualité plutôt que la quantité, et cela se voit dans chaque maison que nous touchons.
                        </p>
                        {' '}
                        <div className="margin-top margin-medium">
                          {' '}
                          <div className="button-group">
                            {' '}
                            <a href="/a-propos" className="button is-secondary w-button">
                              À Propos
                            </a>
                            {' '}
                          </div>
                      ...
                      {' '}
                      <div data-reveal-group="" className="w-layout-grid stats14_item-list">
                        {' '}
                        <div className="stats14_item">
                          {' '}
                          <div className="margin-bottom margin-xxsmall">
                            {' '}
                            <div duration="3000" counter-element="number" className="stats14_number">
                              25+
                            </div>
                            {' '}
                          </div>
                          ...
                          <div className="margin-top margin-xxsmall">
                            {' '}
                            <p>
                              Chaque année apporte son lot de leçons et de perfectionnement
                            </p>
                            {' '}
                          </div>
                          {' '}
                        ...
                        <div className="stats14_item">
                          ...
                          <div className="margin-top margin-xxsmall">
                            {' '}
                            <p>
                              Des maisons qui racontent l'histoire de notre engagement
                            </p>
                            {' '}
                          </div>
                          {' '}
          ...
          {' '}
          <section className="section_layout423 color-scheme-1">
            {' '}
            <div className="padding-global">
              {' '}
              <div className="container-large">
                ...
                <div className="padding-section-large">
                  {' '}
                  <div data-reveal-group="" className="layout423_component">
                    {' '}
                    ...
                    {' '}
                    <div className="w-layout-grid layout423_grid-list">
                      {' '}
                      <div className="layout423_row">
                        ...
                        <a data-w-id="df626311-65f5-f7ae-e458-b9664b55ed4f" href="/renovation" className="layout423_card text-color-white w-inline-block">
                          ...
                          <div id="w-node-df626311-65f5-f7ae-e458-b9664b55ed50-290c3bd4" className="layout423_image-wrapper">
                            {' '}
                            <div data-w-id="df626311-65f5-f7ae-e458-b9664b55ed51" className="layout423_overlay"></div>
                            <img sizes="(max-width: 1536px) 100vw, 1536px" srcSet="/images/relume-655394-p-500.jpeg 500w, /images/relume-655394-p-800.jpeg 800w, /images/relume-655394-p-1080.jpeg 1080w, /images/relume-655394.jpeg 1536w" alt="Projet de rénovation résidentielle par SLC Habitation" src="/images/relume-655394.jpeg" loading="lazy" className="layout423_image" />
                            {' '}
                          </div>
                          {' '}
                          <div className="layout423_card-content">
                            {' '}
                            <div className="margin-bottom margin-xxsmall">
                              {' '}
                            ...
                            <h3 className="heading-style-h4">
                              Un renouveau pour votre maison
                            </h3>
                            {' '}
                            <div data-w-id="df626311-65f5-f7ae-e458-b9664b55ed59" className="layout423_card-content-bottom">
                              {' '}
                              <div className="margin-top margin-small">
                                {' '}
                                <p>
                                  Nous redessinons vos cuisines et salles de bains pour qu'elles reflètent votre style et vos besoins quotidiens.
                                </p>
                                {' '}
                              </div>
                              {' '}
                              <div className="margin-top margin-medium">
                                {' '}
                                <div className="button is-link is-icon is-alternate">
                                  {' '}
                                  <div>
                                    Voir plus
                                  </div>
                        ...
                        <a data-w-id="df626311-65f5-f7ae-e458-b9664b55ed62" href="/agrandissement-construction-neuve" className="layout423_card text-color-white w-inline-block">
                          ...
                          <div id="w-node-df626311-65f5-f7ae-e458-b9664b55ed63-290c3bd4" className="layout423_image-wrapper">
                            {' '}
                            <div data-w-id="df626311-65f5-f7ae-e458-b9664b55ed64" className="layout423_overlay"></div>
                            <img sizes="(max-width: 1024px) 100vw, 1024px" srcSet="/images/relume-655406-p-500.png 500w, /images/relume-655406-p-800.png 800w, /images/relume-655406.png 1024w" alt="Cuisine rénovée sur mesure par SLC Habitation" src="/images/relume-655406.png" loading="lazy" className="layout423_image" />
                            {' '}
                          </div>
                          {' '}
                          <div className="layout423_card-content">
                            ...
                            {' '}
                            <h3 className="heading-style-h4">
                              Agrandissements & constructions neuves
                            </h3>
                            {' '}
                            <div data-w-id="df626311-65f5-f7ae-e458-b9664b55ed6c" className="layout423_card-content-bottom">
                              {' '}
                              <div className="margin-top margin-small">
                                {' '}
                                <p>
                                  Nous construisons l'avenir de votre maison avec des agrandissements et des structures neuves conçus pour durer.
                                </p>
                                {' '}
                              </div>
                              {' '}
                        ...
                        {' '}
                        <a data-w-id="df626311-65f5-f7ae-e458-b9664b55ed75" href="/travaux-sur-mesure" className="layout423_card text-color-white w-inline-block">
                          {' '}
                          <div id="w-node-df626311-65f5-f7ae-e458-b9664b55ed76-290c3bd4" className="layout423_image-wrapper">
                            {' '}
                            <div data-w-id="df626311-65f5-f7ae-e458-b9664b55ed77" className="layout423_overlay"></div>
                            <img sizes="(max-width: 1440px) 100vw, 1440px" srcSet="/images/relume-657281-p-500.jpeg 500w, /images/relume-657281-p-800.jpeg 800w, /images/relume-657281-p-1080.jpeg 1080w, /images/relume-657281.jpeg 1440w" alt="Agrandissement résidentiel réalisé par SLC Habitation" src="/images/relume-657281.jpeg" loading="lazy" className="layout423_image" />
                            {' '}
                          </div>
                          {' '}
                          <div className="layout423_card-content">
                            ...
                            {' '}
                            <div data-w-id="df626311-65f5-f7ae-e458-b9664b55ed7f" className="layout423_card-content-bottom">
                              {' '}
                              <div className="margin-top margin-small">
                                {' '}
                                <p>
                                  Nous protégeons votre investissement par des réparations solides et un entretien régulier adapté à votre maison.
                                </p>
                                {' '}
                              </div>
                              {' '}
                        ...
                        {' '}
                        <div className="layout423_hover-content w-embed w-script">
                          {' '}
                          <style dangerouslySetInnerHTML={{ __html: `
...
` }} />
              ...
              <div className="container-large">
                ...
                <div className="padding-section-large">
                  ...
                  <div data-reveal-group="" className="gallery8_component">
                    ...
                    {' '}
                    <div data-reveal-group-nested="" className="gallery8_list">
                      {' '}
                      <a href="/images/relume-655453.jpeg" className="gallery8_lightbox-link w-inline-block w-lightbox">
                        {' '}
  ...
  "items": [
    {
      "url": "images/relume-655453.jpeg",
      "fileName": "relume-655453.jpeg",
      "origFileName": "relume-655453.jpeg",
      "fileSize": 0,
      "height": 0,
      "width": 0,
      "type": "image",
      "caption": "Cuisine moderne rénovée par SLC Habitation"
    }
  ],
  "group": "portfolio-home"
                      ...
                      {' '}
                      <a href="/images/relume-657284-p-800.png" className="gallery8_lightbox-link w-inline-block w-lightbox">
                        {' '}
  ...
  "items": [
    {
      "url": "images/relume-657284-p-800.png",
      "fileName": "relume-657284-p-800.png",
      "origFileName": "relume-657284-p-800.png",
      "fileSize": 0,
      "height": 0,
      "width": 0,
      "type": "image",
      "caption": "Projet de rénovation résidentielle SLC Habitation"
    }
  ],
  "group": "portfolio-home"
}` }} />
                      ...
                      {' '}
                      <a href="/images/relume-567908.jpeg" className="gallery8_lightbox-link w-inline-block w-lightbox">
                        {' '}
                        <div className="gallery8_image-wrapper">
  ...
  "items": [
    {
      ...
      "width": 0,
      "type": "image",
      "caption": "Salle de bain rénovée par SLC Habitation"
    }
  ],
  "group": "portfolio-home"
}` }} />
                      ...
                      {' '}
                      <a href="/images/relume-567906.jpeg" className="gallery8_lightbox-link w-inline-block w-lightbox">
                        {' '}
                        <div className="gallery8_image-wrapper-large">
  ...
  "items": [
    {
      ...
      "width": 0,
      "type": "image",
      "caption": "Intérieur résidentiel rénové par SLC Habitation"
    }
  ],
  "group": "portfolio-home"
}` }} />
              ...
              <div className="container-large">
                ...
                <div className="padding-section-large">
                  ...
                  <div data-reveal-group="" className="faq2_component">
                    ...
                    {' '}
                    <div data-reveal-group-nested="" className="faq2_list">
                      {' '}
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="df626311-65f5-f7ae-e458-b9664b55ee26" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-df626311-65f5-f7ae-e458-b9664b55ee26">
                          {' '}
                        ...
                        {' '}
                        <div id="faq-answer-df626311-65f5-f7ae-e458-b9664b55ee26" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="df626311-65f5-f7ae-e458-b9664b55ee31" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-df626311-65f5-f7ae-e458-b9664b55ee31">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-df626311-65f5-f7ae-e458-b9664b55ee31" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="df626311-65f5-f7ae-e458-b9664b55ee3c" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-df626311-65f5-f7ae-e458-b9664b55ee3c">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-df626311-65f5-f7ae-e458-b9664b55ee3c" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="df626311-65f5-f7ae-e458-b9664b55ee47" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-df626311-65f5-f7ae-e458-b9664b55ee47">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-df626311-65f5-f7ae-e458-b9664b55ee47" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="df626311-65f5-f7ae-e458-b9664b55ee52" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-df626311-65f5-f7ae-e458-b9664b55ee52">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-df626311-65f5-f7ae-e458-b9664b55ee52" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                ...
                <div className="padding-bottom padding-xxlarge">
                  ...
                  <div className="w-layout-grid footer3_top-wrapper">
                    ...
                    <div className="footer3_left-wrapper">
                      ...
                      <div className="margin-bottom margin-medium">
                        {' '}
                        <a href="/" aria-current="page" className="footer3_logo-link w-nav-brand w--current">
                    ...
                    <div className="w-layout-grid footer3_menu-wrapper">
                      ...
                      <div className="footer3_link-list">
                        {' '}
                        <a href="/" aria-current="page" className="footer3_link w--current">
                          Accueil
                        </a>
                        {' '}
