...
const detailPhotos = [
  {
    src: '/images/INT%C3%89RIEUR/Cuisine/finitions-cuisine-01.jpg',
    alt: 'Cuisine avec îlot en bois, armoires blanches et suspensions',
    width: 1200,
    height: 1600,
    caption: 'Îlot en bois et armoires blanches',
    text: 'Un îlot en bois, des armoires blanches et des suspensions structurent cette cuisine.',
  },
  {
    src: '/images/INT%C3%89RIEUR/Cuisine/finitions-cuisine-02.jpg',
    alt: 'Cuisine ouverte avec grand îlot, armoires blanches et plancher clair',
    width: 2048,
    height: 1536,
    caption: 'Cuisine ouverte et grand îlot',
    text: 'La cuisine s’ouvre sur l’aire de vie autour d’un grand îlot central.',
  },
  {
