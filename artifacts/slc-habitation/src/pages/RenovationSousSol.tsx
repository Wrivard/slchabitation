...
` }} />
        ...
        <main className="main-wrapper">
          ...
          <div data-collapse="medium" data-animation="over-left" data-duration="400" fs-scrolldisable-element="smart-nav" data-easing="ease" data-easing2="ease" role="banner" className="navbar3_component color-scheme-1 w-nav">
            ...
            <div className="navbar3_container">
              ...
              <nav id="site-navigation" role="navigation" className="navbar3_menu w-nav-menu">
                ...
                {' '}
                <a href="/formulaire" data-service="renovation-sous-sol" className="navbar3_tablet-menu-button w-button">
                  Soumission
                </a>
                {' '}
              </nav>
              ...
              {' '}
              <a id="w-node-e94d028c-b457-e648-e3c9-1bebe5f245fc-e5f245dc" href="/formulaire" data-service="renovation-sous-sol" className="button w-button">
                Soumission
              </a>
              {' '}
          ...
          {' '}
          <section className="relative py-20 md:py-28 bg-mine-shaft text-white overflow-hidden">
            {' '}
            <div className="absolute inset-0 z-0 bg-black">
              {' '}
              <img src="/images/relume-657406.jpeg" width="2048" height="1536" sizes="100vw" srcSet="/images/relume-657406-p-500.jpeg 500w, /images/relume-657406-p-800.jpeg 800w, /images/relume-657406-p-1080.jpeg 1080w, /images/relume-657406-p-1600.jpeg 1600w, /images/relume-657406-p-2000.jpeg 2000w, /images/relume-657406.jpeg 2048w" fetchPriority="high" alt="Sous-sol aménagé par SLC Habitation" className="w-full h-full object-cover opacity-50" />
              {' '}
            </div>
            {' '}
            <div className="container-large relative z-10 px-6 max-w-4xl mx-auto text-center fade-up">
              {' '}
              ...
              <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
                Transformez votre sous-sol en salle familiale ou appartement complet. Nous concevons et réalisons des projets sur mesure avec une finition soignée.
              </p>
              {' '}
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                {' '}
                <a href="/formulaire" data-service="renovation-sous-sol" className="cta-link !bg-[#f58026] hover:bg-[#d86d1b] transition-colors px-8 py-4 rounded-lg font-medium text-lg w-full sm:w-auto text-white text-center shadow-md">
                  Obtenir une estimation
                </a>
                {' '}
              </div>
              {' '}
              <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-gray-300 font-medium">
                {' '}
            ...
            <div className="container-large px-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="fade-up">
                  {' '}
                  <span className="text-[#f58026] font-semibold tracking-wide uppercase text-sm mb-2 block">
                    Notre Différence
                  </span>
                  {' '}
                  <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6 text-mine-shaft">
                  ...
                  <div className="space-y-8 mt-10">
                    ...
                    <div className="flex gap-5">
                      {' '}
                      <div className="flex-shrink-0 w-12 h-12 rounded-full !bg-[#f58026]/10 flex items-center justify-center text-[#f58026]">
                        {' '}
                      ...
                      <div>
                        {' '}
                        <h3 className="text-xl font-semibold mb-2 text-mine-shaft">
                          Isolation et confort maîtrisés
                        </h3>
                        {' '}
                    ...
                    <div className="flex gap-5">
                      ...
                      <div>
                        ...
                        {' '}
                        <p className="text-neutral-dark leading-relaxed">
                          Nous repensons la configuration pour cacher élégamment la mécanique du bâtiment (conduits, poutres) tout en préservant la hauteur sous plafond et la circulation de la lumière naturelle.
                        </p>
                        {' '}
                      </div>
                      {' '}
                    ...
                    <div className="flex gap-5">
                      ...
                      <div>
                        ...
                        {' '}
                        <p className="text-neutral-dark leading-relaxed">
                          Un sous-sol aménagé selon les règles de l'art par un entrepreneur licencié RBQ peut contribuer à la valeur d'usage et de revente de votre propriété.
                        </p>
                        {' '}
                      </div>
                      {' '}
                ...
                {' '}
                <div className="relative fade-up delay-200 space-y-6">
                  {' '}
                  <div className="relative">
                    {' '}
                    <div className="absolute -inset-4 !bg-[#f58026]/10 rounded-[2rem] transform rotate-3 transition-transform hover:rotate-6 duration-700"></div>
                    {' '}
                    <img src="/images/INT%C3%89RIEUR/randoms/20241017_152123.jpg" width="4000" height="3000" sizes="(max-width: 800px) 100vw, 800px" srcSet="/images/INT%C3%89RIEUR/randoms/20241017_152123-p-500.jpg 500w, /images/INT%C3%89RIEUR/randoms/20241017_152123-p-800.jpg 800w, /images/INT%C3%89RIEUR/randoms/20241017_152123-p-1080.jpg 1080w, /images/INT%C3%89RIEUR/randoms/20241017_152123-p-1600.jpg 1600w, /images/INT%C3%89RIEUR/randoms/20241017_152123-p-2000.jpg 2000w, /images/INT%C3%89RIEUR/randoms/20241017_152123.jpg 4000w" loading="lazy" alt="Sous-sol après des travaux de finition" className="relative rounded-[2rem] shadow-2xl w-full object-cover aspect-[4/5] object-center border-4 border-white" />
                    {' '}
                  </div>
                  {' '}
                </div>
          ...
          <section className="py-24 bg-white">
            ...
            <div className="container-large px-6">
              ...
              <div className="text-center max-w-3xl mx-auto mb-16 fade-up">
                {' '}
                <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4 text-mine-shaft">
                  Notre processus de travail
                </h2>
                {' '}
                <p className="text-neutral-dark text-lg">
                  De la première rencontre à la livraison, nous assurons une communication transparente et une exécution rigoureuse.
                </p>
                {' '}
              </div>
              {' '}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                {' '}
                <div className="bg-neutral-lightest p-8 rounded-2xl fade-up">
                  {' '}
                  <div className="text-4xl font-heading font-bold text-[#f58026]/30 mb-4">
                    01
                  </div>
                  {' '}
                  <h3 className="text-xl font-bold mb-3 text-mine-shaft">
                    Évaluation et conception
                  </h3>
                  {' '}
                  <p className="text-neutral-dark">
                    Inspection de l'état actuel et proposition d'un plan d'aménagement maximisant chaque pied carré de votre sous-sol.
                  </p>
                  {' '}
                </div>
                {' '}
                <div className="bg-neutral-lightest p-8 rounded-2xl fade-up delay-100">
                  {' '}
                  <div className="text-4xl font-heading font-bold text-[#f58026]/30 mb-4">
                    02
                  </div>
                  ...
                  {' '}
                  <p className="text-neutral-dark">
                    Nous listons les matériaux, les étapes de réalisation et les coûts pour assurer un processus structuré et transparent.
                  </p>
                  {' '}
                </div>
                {' '}
                <div className="bg-neutral-lightest p-8 rounded-2xl fade-up delay-200">
                  {' '}
                  <div className="text-4xl font-heading font-bold text-[#f58026]/30 mb-4">
                    03
                  </div>
                  ...
                  {' '}
                  <p className="text-neutral-dark">
                    Nos équipes protègent vos espaces de vie et accordent une attention soutenue aux détails de finition.
                  </p>
                  {' '}
                </div>
                {' '}
              ...
              {' '}
              <div className="max-w-4xl mx-auto bg-neutral-lightest rounded-[2rem] p-10 border border-neutral-lighter fade-up">
                {' '}
                <h3 className="text-2xl font-bold mb-8 text-mine-shaft text-center">
                  Questions fréquentes sur la rénovation de sous-sol
                </h3>
                {' '}
                <div className="space-y-4">
                  {' '}
                  <details className="group bg-white rounded-xl border border-neutral-lighter">
                    {' '}
                    <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-5 text-mine-shaft">
                      {' '}
                      <span>
                        Quelles sont les étapes pour insonoriser un sous-sol ?
                      </span>
                      {' '}
                    ...
                    {' '}
                    <div className="text-neutral-dark px-5 pb-5 leading-relaxed">
                      {' L\'approche dépend de la structure et de l\'usage prévu. Elle peut comprendre des barres résilientes, de la laine insonorisante et des couches de gypse adaptées. '}
                    </div>
                    {' '}
                  </details>
                  {' '}
                  <details className="group bg-white rounded-xl border border-neutral-lighter">
                    ...
                    <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-5 text-mine-shaft">
                      {' '}
                      <span>
                        Faut-il traiter l'humidité avant de finir le sous-sol ?
                      </span>
                      {' '}
                      <span className="transition group-open:rotate-180">
                        {' '}
                    ...
                    {' '}
                    <div className="text-neutral-dark px-5 pb-5 leading-relaxed">
                      {' Oui. Il faut d\'abord vérifier les signes d\'infiltration, l\'état de la fondation et le taux d\'humidité avant de planifier l\'isolation et la finition. '}
                    </div>
                    {' '}
                  </details>
                  {' '}
                  <details className="group bg-white rounded-xl border border-neutral-lighter">
                    ...
                    <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-5 text-mine-shaft">
                      {' '}
                      <span>
                        Est-ce possible d'ajouter une salle de bain au sous-sol si la plomberie n'est pas prévue ?
                      </span>
                      {' '}
                      <span className="transition group-open:rotate-180">
                        {' '}
                    ...
                    {' '}
                    <div className="text-neutral-dark px-5 pb-5 leading-relaxed">
                      {' C\'est souvent possible après une évaluation des drains, du renvoi principal et de la dalle afin de déterminer les travaux de plomberie requis. '}
                    </div>
                    {' '}
                  </details>
                  {' '}
              ...
              {' '}
              <div className="max-w-4xl mx-auto mt-16 text-center fade-up">
                {' '}
                <div className="inline-flex flex-col items-center p-8 bg-neutral-lightest rounded-[2rem] border border-neutral-lighter relative">
                  {' '}
                  <div className="text-[#f58026] mb-4">
                    {' '}
                  ...
                  {' '}
                  <blockquote className="text-lg text-mine-shaft font-medium italic mb-6">
          ...
          {' '}
          <section className="py-24 bg-mine-shaft text-white relative overflow-hidden">
            {' '}
            <div className="container-large px-6 relative z-10 text-center max-w-3xl mx-auto fade-up">
              {' '}
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6">
                Prêt à maximiser votre espace ?
              </h2>
              {' '}
              <p className="text-lg text-gray-300 mb-10">
                Confiez-nous votre sous-sol. Nous prenons en charge la gestion complète des travaux, de la démolition jusqu'au coup de pinceau final.
              </p>
              {' '}
              <a href="/formulaire" data-service="renovation-sous-sol" className="cta-link inline-block !bg-[#f58026] hover:bg-[#d86d1b] transition-colors px-10 py-5 rounded-lg font-bold text-lg text-white shadow-xl hover:-translate-y-1 transform duration-300">
                Demander une soumission gratuite
              </a>
              {' '}
            </div>
            {' '}
            <div className="absolute -right-64 -bottom-64 w-[500px] h-[500px] !bg-[#f58026]/20 rounded-full blur-3xl"></div>
            {' '}
            <div className="absolute -left-64 -top-64 w-[500px] h-[500px] !bg-[#f58026]/10 rounded-full blur-3xl"></div>
            {' '}
          </section>
          {' '}
        </main>
                  ...
                  <div className="w-layout-grid footer3_top-wrapper">
                      ...
                      <div className="w-layout-grid footer3_social-list">
                        ...
                        <a aria-label="Facebook de SLC Habitation" href="https://www.facebook.com/SLCHabitation" target="_blank" rel="noopener" className="footer3_social-link w-inline-block">
                          ...
                          <div className="icon-embed-xsmall w-embed">
                            <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              {' '}
                        ...
                        {' '}
                        <a hidden aria-hidden="true" className="footer3_social-link w-inline-block">
                          {' '}
                          <div className="icon-embed-xsmall w-embed">
                            <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              {' '}
                    ...
                    <div className="w-layout-grid footer3_menu-wrapper">
                      ...
                      <div className="footer3_link-list">
                        ...
                        {' '}
                        <a href="/formulaire" data-service="renovation-sous-sol" className="footer3_link">
                          Soumission
                        </a>
                        {' '}
                      </div>
