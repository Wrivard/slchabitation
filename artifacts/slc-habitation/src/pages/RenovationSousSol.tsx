        ...
        <main className="main-wrapper">
          ...
          <div data-collapse="medium" data-animation="over-left" data-duration="400" fs-scrolldisable-element="smart-nav" data-easing="ease" data-easing2="ease" role="banner" className="navbar3_component color-scheme-1 w-nav">
            ...
            <div className="navbar3_container">
              ...
              <nav id="site-navigation" role="navigation" className="navbar3_menu w-nav-menu">
                ...
                {' '}
                <a href="/soumission" data-service="renovation-sous-sol" className="navbar3_tablet-menu-button w-button">
                  Soumission
                </a>
                {' '}
              </nav>
              ...
              {' '}
              <a id="w-node-e94d028c-b457-e648-e3c9-1bebe5f245fc-e5f245dc" href="/soumission" data-service="renovation-sous-sol" className="button w-button">
                Soumission
              </a>
              {' '}
          ...
          <section className="relative py-20 md:py-28 bg-mine-shaft text-white overflow-hidden">
            ...
            <div className="container-large relative z-10 px-6 max-w-4xl mx-auto text-center fade-up">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                {' '}
              <a href="/soumission" data-service="renovation-sous-sol" className="cta-link !bg-[#f58026] hover:bg-[#d86d1b] transition-colors px-8 py-4 rounded-lg font-medium text-lg w-full sm:w-auto text-white text-center shadow-md">
          ...
          <section className="py-24 bg-mine-shaft text-white relative overflow-hidden">
            ...
            <div className="container-large px-6 relative z-10 text-center max-w-3xl mx-auto fade-up">
              ...
              {' '}
              <a href="/soumission" data-service="renovation-sous-sol" className="cta-link inline-block !bg-[#f58026] hover:bg-[#d86d1b] transition-colors px-10 py-5 rounded-lg font-bold text-lg text-white shadow-xl hover:-translate-y-1 transform duration-300">
                  ...
                  <div className="w-layout-grid footer3_top-wrapper">
                    ...
                    <div className="w-layout-grid footer3_menu-wrapper">
                      ...
                      <div className="footer3_link-list">
                        ...
                        {' '}
                        <a href="/soumission" data-service="renovation-sous-sol" className="footer3_link">
                          Soumission
                        </a>
                        {' '}
                      </div>
