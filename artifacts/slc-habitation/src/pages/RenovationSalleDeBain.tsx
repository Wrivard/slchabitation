...
` }} />
        ...
        <main className="main-wrapper">
          ...
          <section className="py-24 bg-white">
            ...
            <div className="container-large px-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center flex-col-reverse lg:flex-row-reverse">
                {' '}
                <div className="order-2 lg:order-1 relative fade-up space-y-6">
                  {' '}
                  <div className="relative">
                    {' '}
                    <div className="absolute -inset-4 bg-mine-shaft/5 rounded-[2rem] transform -rotate-3 transition-transform hover:-rotate-6 duration-700"></div>
                    {' '}
                    <img src="/images/relume-655419.jpeg" width="1536" height="2048" sizes="(max-width: 800px) 100vw, 800px" srcSet="/images/relume-655419-p-500.jpeg 500w, /images/relume-655419-p-800.jpeg 800w, /images/relume-655419.jpeg 1536w" loading="lazy" alt="Détail de salle de bain" className="relative rounded-[2rem] shadow-2xl w-full object-cover aspect-square object-center border-4 border-white" />
                    {' '}
                  </div>
                  {' '}
                </div>
                {' '}
                <div className="order-1 lg:order-2 fade-up delay-200">
                  {' '}
                  ...
                  <ul className="space-y-6">
                    ...
                    <li className="flex items-start">
                      {' '}
                      <svg className="w-6 h-6 text-[#f58026] mt-1 mr-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      {' '}
                      <div>
                        {' '}
                        <strong className="block text-mine-shaft text-lg">
                          Étanchéité planifiée (membrane Schluter)
                        </strong>
                        {' '}
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        {' '}
                        <strong className="block text-mine-shaft text-lg">
                          Pose de céramique haute précision
                        </strong>
                        {' '}
                        <span className="text-neutral-dark">
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        {' '}
                        <strong className="block text-mine-shaft text-lg">
                          Ventilation et chauffage repensés
                        </strong>
                        {' '}
                        <span className="text-neutral-dark">
                          Planchers chauffants et systèmes d'extraction d'air performants pour un confort optimisé au quotidien.
                        </span>
                        {' '}
                      </div>
                      {' '}
                ...
                <div className="space-y-4">
                  ...
                  <details className="group bg-white rounded-xl border border-neutral-lighter">
                    ...
                    <div className="text-neutral-dark px-5 pb-5 leading-relaxed">
                      {' Pas systématiquement. La plomberie doit toutefois être adaptée si les appareils sont déplacés, et son état peut être évalué lorsque les murs sont ouverts. '}
                    </div>
                    {' '}
                  </details>
                  {' '}
                  <details className="group bg-white rounded-xl border border-neutral-lighter">
                    ...
                    <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-5 text-mine-shaft">
                      {' '}
                      <span>
                        Comment assurer une bonne étanchéité pour une douche italienne ?
                      </span>
                      {' '}
                      <span className="transition group-open:rotate-180">
                        {' '}
                    ...
                    {' '}
                    <div className="text-neutral-dark px-5 pb-5 leading-relaxed">
                      {' Une douche italienne exige une imperméabilisation soignée. Un système de membrane appliqué sur les murs et le plancher, avec un drain adapté et une pente précise, forme une barrière continue avant la pose de la céramique. '}
                    </div>
                    {' '}
                  </details>
                  {' '}
                  <details className="group bg-white rounded-xl border border-neutral-lighter">
                    ...
                    {' '}
                    <div className="text-neutral-dark px-5 pb-5 leading-relaxed">
                      {' La compatibilité dépend du système et du revêtement. La céramique et la pierre conduisent bien la chaleur; les spécifications du fabricant doivent être vérifiées pour les autres matériaux. '}
                    </div>
                    {' '}
                  </details>
                  {' '}
          ...
          {' '}
          <section className="py-24 bg-neutral-lightest relative overflow-hidden">
            {' '}
