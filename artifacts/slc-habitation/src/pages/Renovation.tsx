 ...
 * Page « /renovation ».
 *
 * Convertie depuis l'export Webflow (`site/renovation.html`) : même balisage,
                    ...
                    <div data-reveal-group="" className="max-width-large">
                      ...
                      <div className="margin-bottom margin-small">
                        ...
                        <h1 className="heading-style-h1">
                          Rénovation résidentielle à Laval et dans les Laurentides
                        </h1>
                        {' '}
                      </div>
                      {' '}
                      <p className="text-size-medium">
                        Depuis plus de 25 ans, nous transformons les espaces avec précision et respect du détail
                      </p>
                      {' '}
                      ...
                      <div id="w-node-_941c4f78-5627-204c-7653-1022e728ca34-7b2d3a5f" className="layout201_content-right">
                        ...
                        <div className="w-layout-grid layout201_item-list">
                          ...
                          <div className="layout201_item">
                            ...
                            <div className="margin-bottom margin-xsmall">
                              ...
                              <div className="layout201_item-icon-wrapper">
                                ...
                                <div className="icon-1x1-medium w-embed">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 -960 960 960">
                                    {' '}
                                    <path fill="currentColor" d="M265.93-154.07V-300q0-14.42 9.83-24.24 9.82-9.83 24.24-9.83h145.93V-480q0-14.42 9.83-24.24 9.82-9.83 24.24-9.83h145.93V-660q0-14.42 9.83-24.24 9.82-9.83 24.24-9.83h145.93V-810q0-14.42 9.88-24.24 9.87-9.83 24.37-9.83 14.49 0 24.19 9.83 9.7 9.82 9.7 24.24v150q0 14.42-9.83 24.24-9.82 9.83-24.24 9.83H694.07V-480q0 14.42-9.83 24.24-9.82 9.83-24.24 9.83H514.07V-300q0 14.42-9.83 24.24-9.82 9.83-24.24 9.83H334.07V-120q0 14.42-9.83 24.24-9.82 9.83-24.24 9.83H150q-14.42 0-24.24-9.88-9.83-9.87-9.83-24.37 0-14.49 9.83-24.19 9.82-9.7 24.24-9.7h115.93Z" />
                                    {' '}
                                  </svg>
                                </div>
                                {' '}
                            ...
                            <div className="margin-bottom margin-xsmall">
                              ...
                              <h3 className="heading-style-h6">
                                Sous-sols transformés
                              </h3>
                              {' '}
                            </div>
                            {' '}
                            <p>
                              Nous créons des espaces fonctionnels et accueillants sous terre
                            </p>
                            {' '}
                          </div>
                          {' '}
                          <div className="layout201_item">
                            ...
                            {' '}
                            <p>
                              Des installations complètes qui combinent style et fonctionnalité
                            </p>
                            {' '}
                          </div>
                          {' '}
                        ...
                        <div className="layout356_content-left">
                          ...
                          <div className="margin-bottom margin-small">
                            ...
                            <h2 className="heading-style-h2">
                              ...
                              {' votre cuisine en un espace moderne'}
                            </h2>
                            {' '}
                          </div>
                          {' '}
                          <p className="text-size-medium">
                            Notre équipe crée des cuisines fonctionnelles et esthétiques. Chaque projet est personnalisé pour répondre à vos besoins.
                          </p>
                          {' '}
                          <div className="margin-top margin-medium">
                            {' '}
                        ...
                        <div className="layout356_content-left">
                          ...
                          <div className="margin-bottom margin-small">
                            ...
                            <h2 className="heading-style-h2">
                              ...
                              {' votre oasis de détente à domicile'}
                            </h2>
                            {' '}
                          </div>
                          {' '}
                          <p className="text-size-medium">
                            Nous transformons votre salle de bain en un espace relaxant. Profitez d'une rénovation qui allie confort et style.
                          </p>
                          {' '}
                          <div className="margin-top margin-medium">
                            {' '}
                        ...
                        <div className="layout356_content-left">
                          ...
                          <div className="margin-bottom margin-small">
                            ...
                            <h2 className="heading-style-h2">
                              ...
                              {' votre espace avec un sous-sol rénové'}
                            </h2>
                            {' '}
                          </div>
                          {' '}
                          <p className="text-size-medium">
                            Transformez votre sous-sol en un espace de vie agréable. Que ce soit pour un bureau ou une salle de jeux, nous avons la solution.
                          </p>
                          {' '}
                          <div className="margin-top margin-medium">
                            {' '}
                      ...
                      <div id="w-node-_941c4f78-5627-204c-7653-1022e728caba-7b2d3a5f" className="layout203_content-right">
                        ...
                        <div className="w-layout-grid layout203_item-list">
                          ...
                          <div className="layout203_item">
                            ...
                            {' '}
                            <p>
                              Chaque détail compte. Nous construisons comme si c'était notre propre demeure.
                            </p>
                            {' '}
                          </div>
                          {' '}
                          <div className="layout203_item">
                            ...
                            {' '}
                            <p>
                              Nous choisissons ce qui résiste au temps et aux épreuves du quotidien.
                            </p>
                            {' '}
                          </div>
                          {' '}
                  ...
                  <div data-reveal-group="" className="faq2_component">
                    ...
                    <div className="faq2_list">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="941c4f78-5627-204c-7653-1022e728cb71" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-941c4f78-5627-204c-7653-1022e728cb71">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-941c4f78-5627-204c-7653-1022e728cb71" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="941c4f78-5627-204c-7653-1022e728cb7c" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-941c4f78-5627-204c-7653-1022e728cb7c">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-941c4f78-5627-204c-7653-1022e728cb7c" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="941c4f78-5627-204c-7653-1022e728cb87" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-941c4f78-5627-204c-7653-1022e728cb87">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-941c4f78-5627-204c-7653-1022e728cb87" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="941c4f78-5627-204c-7653-1022e728cb92" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-941c4f78-5627-204c-7653-1022e728cb92">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-941c4f78-5627-204c-7653-1022e728cb92" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="941c4f78-5627-204c-7653-1022e728cb9d" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-941c4f78-5627-204c-7653-1022e728cb9d">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-941c4f78-5627-204c-7653-1022e728cb9d" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
