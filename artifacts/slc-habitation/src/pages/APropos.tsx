 ...
 * Page « /a-propos ».
 *
 * Convertie depuis l'export Webflow (`site/a-propos.html`) : même balisage,
...
` }} />
        ...
        <main className="main-wrapper">
          ...
          <div data-collapse="medium" data-animation="over-left" data-duration="400" fs-scrolldisable-element="smart-nav" data-easing="ease" data-easing2="ease" role="banner" className="navbar3_component color-scheme-1 w-nav">
            ...
            <div className="navbar3_container">
              ...
              <nav id="site-navigation" role="navigation" className="navbar3_menu w-nav-menu">
                ...
                {' '}
                <a href="/a-propos" aria-current="page" className="navbar3_link w-nav-link w--current">
                  À Propos
                </a>
                {' '}
                  ...
                  <div className="header50_component">
                    ...
                    <div data-reveal-group="" className="max-width-large">
                      ...
                      <p className="text-size-medium">
                        Avec des années d'expérience, nous transformons vos rêves de rénovation en réalité.
                      </p>
                      {' '}
          ...
          {' '}
          <section className="section_layout118 color-scheme-1">
            {' '}
            <div className="padding-global">
              {' '}
              <div className="container-large">
                ...
                <div className="padding-section-large">
                  {' '}
                  <div data-reveal-group="" className="layout118_component">
                    {' '}
                    <div className="margin-bottom margin-xxlarge">
                      {' '}
                      <div className="w-layout-grid layout118_content">
                        {' '}
                        <div className="layout118_content-left">
                          {' '}
                        ...
                        {' '}
                        <div className="layout118_content-right">
                          {' '}
                          <div className="margin-bottom margin-medium">
                            {' '}
                            <p className="text-size-medium">
                              Depuis près de deux décennies, SLC Habitation bâtit des espaces durables. Chaque projet raconte une histoire de transformation et de dévouement.
                            </p>
                            {' '}
                          </div>
                          {' '}
                          <div className="w-layout-grid layout118_item-list">
                            {' '}
                            <div className="layout118_text-wrapper">
                              {' '}
                              <div className="margin-bottom margin-xxsmall">
                                {' '}
                                <div className="heading-style-h2 stats">
                                  <span duration="3000" counter-element="number">
                                    18
                                  </span>
                                  +
                                </div>
                              ...
                              {' '}
                              <p>
                                Ans de savoir-faire en construction résidentielle
                              </p>
                              {' '}
                            </div>
                            {' '}
                            <div className="layout118_text-wrapper">
                              ...
                              {' '}
                              <p>
                                Familles qui nous font confiance pour leurs rêves
                              </p>
                              {' '}
                            </div>
                            {' '}
                    ...
                    {' '}
                    <div className="layout118_image-wrapper" style={{ display: 'none' }}>
                      <img loading="lazy" src="/images/Placeholder-Image---Landscape.svg" alt="" className="layout118_image" />
                    </div>
                    {' '}
                  </div>
                  {' '}
          ...
          {' '}
          <section className="section_timeline20 color-scheme-1">
            {' '}
            <div className="padding-global">
              {' '}
              <div className="container-large">
                ...
                <div className="padding-section-large">
                  {' '}
                  <div data-reveal-group="" className="timeline20_component">
                    {' '}
                    <div className="margin-bottom margin-xxlarge">
                      {' '}
                      <div className="max-width-large">
                        ...
                        <div className="margin-bottom margin-small">
                          ...
                          <h2 className="heading-style-h2">
                            Notre parcours au fil des années
                          </h2>
                          {' '}
                        </div>
                        {' '}
                        <p className="text-size-medium">
                          Depuis notre création, nous avons su évoluer et nous adapter aux besoins de nos clients. Chaque projet réalisé témoigne de notre engagement envers la qualité et l'excellence.
                        </p>
                        {' '}
                        <div className="margin-top margin-medium">
                          {' '}
                          <div className="button-group">
                            {' '}
                            <a href="/soumission" className="button is-secondary w-button">
                              Soumission en ligne
                            </a>
                            {' '}
                    ...
                    {' '}
                    <div className="timeline20_content">
                      {' '}
                      <div data-reveal-group-nested="" className="timeline20_list">
                        {' '}
                        <div className="timeline20_item">
                          {' '}
                          <div className="timeline20_empty-space"></div>
                          {' '}
                          <div className="timeline20_progress-wrapper">
                            {' '}
                            <div className="timeline20_circle"></div>
                            {' '}
                            <div className="timeline20_progress-line"></div>
                            {' '}
                          </div>
                          {' '}
                          <div className="timeline20_item-content">
                            {' '}
                            <div className="margin-bottom margin-xxsmall">
                              {' '}
                            ...
                            {' '}
                            <p>
                              L’entreprise amorce ses activités dans le domaine de la rénovation résidentielle, mettant à profit une solide expérience terrain et une passion pour le travail bien fait.
                            </p>
                            {' '}
                          </div>
                          {' '}
                        ...
                        <div className="timeline20_item">
                          {' '}
                          <div id="w-node-_0ecc3351-5422-24a4-66bb-031667706547-688efdad" className="timeline20_item-content">
                            {' '}
                            <div className="margin-bottom margin-xxsmall">
                              {' '}
                              <h3 className="heading-style-h5">
                            ...
                            {' '}
                            <p>
                              Au fil des années, SLC Habitation développe une expertise reconnue en rénovation et en agrandissement résidentiel, répondant à une clientèle de plus en plus variée.
                            </p>
                            {' '}
                          </div>
                          {' '}
                          <div id="w-node-_0ecc3351-5422-24a4-66bb-03166770654d-688efdad" className="timeline20_progress-wrapper">
                            {' '}
                            <div className="timeline20_circle"></div>
                            {' '}
                            <div className="timeline20_progress-line"></div>
                        ...
                        <div className="timeline20_item">
                          ...
                          <div className="timeline20_item-content">
                            ...
                            {' '}
                            <p>
                              L’entreprise maintient une présence active et constante, mettant de l’avant la qualité d’exécution, les finitions soignées et le respect des attentes des clients.
                            </p>
                            {' '}
                          </div>
                          {' '}
                        ...
                        <div className="timeline20_item">
                          {' '}
                          <div id="w-node-_0ecc3351-5422-24a4-66bb-03166770655d-688efdad" className="timeline20_item-content">
                            {' '}
                            <div className="margin-bottom margin-xxsmall">
                              {' '}
                              <h3 className="heading-style-h5">
                            ...
                            {' '}
                            <p>
                              Aujourd’hui, SLC Habitation s’appuie sur plus de 25 ans d’expérience cumulée dans le secteur résidentiel, poursuivant sa mission avec la même exigence de qualité et de professionnalisme.
                            </p>
                            {' '}
                          </div>
                          {' '}
                          <div id="w-node-_0ecc3351-5422-24a4-66bb-031667706563-688efdad" className="timeline20_progress-wrapper">
                            {' '}
                            <div className="timeline20_circle"></div>
                            {' '}
                            <div className="timeline20_progress-line"></div>
                      ...
                      {' '}
                      <div className="timeline20_fade-overlay-right"></div>
                      {' '}
                    </div>
                    {' '}
                  </div>
                  ...
                  <div data-reveal-group="" className="faq2_component">
                    ...
                    <div className="faq2_list">
                      ...
                      <div className="faq2_accordion">
                        ...
                        {' '}
                        <div id="faq-answer-0ecc3351-5422-24a4-66bb-031667706605" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        ...
                        {' '}
                        <div id="faq-answer-0ecc3351-5422-24a4-66bb-031667706610" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        ...
                        {' '}
                        <div id="faq-answer-0ecc3351-5422-24a4-66bb-03166770661b" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        ...
                        {' '}
                        <div id="faq-answer-0ecc3351-5422-24a4-66bb-031667706626" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        ...
                        {' '}
                        <div id="faq-answer-0ecc3351-5422-24a4-66bb-031667706631" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                  ...
                  <div className="w-layout-grid footer3_top-wrapper">
                    ...
                    <div className="w-layout-grid footer3_menu-wrapper">
                      ...
                      <div className="footer3_link-list">
                        ...
                        {' '}
                        <a href="/a-propos" aria-current="page" className="footer3_link w--current">
                          À propos
                        </a>
                        {' '}
