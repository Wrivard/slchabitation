 ...
 * Page « /soumission ».
 *
 * Convertie depuis l'export Webflow (`site/soumission.html`) : même balisage,
        ...
        <main className="main-wrapper">
          ...
          <div data-collapse="medium" data-animation="over-left" data-duration="400" fs-scrolldisable-element="smart-nav" data-easing="ease" data-easing2="ease" role="banner" className="navbar3_component color-scheme-1 w-nav">
            ...
            <div className="navbar3_container">
              ...
              {' '}
              <a id="w-node-e94d028c-b457-e648-e3c9-1bebe5f245fc-e5f245dc" href="/soumission" aria-current="page" className="button w-button w--current">
                Soumission
              </a>
              {' '}
                  ...
                  <div className="header50_component">
                    ...
                    <div data-reveal-group="" className="max-width-large">
                      ...
                      <div className="margin-bottom margin-xsmall">
                        {' '}
                        <div className="text-style-tagline text-color-white soumission-hero__label">
                          Soumission en ligne
                        </div>
                        {' '}
                      </div>
                      ...
                      {' '}
                      <p className="text-size-medium soumission-hero__intro">
          ...
          <section className="section_contact6 color-scheme-1">
            ...
            <div className="padding-global">
              ...
              <div className="container-large">
                ...
                <div className="padding-section-large">
                  {' '}
                  <div className="contact6_component">
                    {' '}
                  ...
                  <div data-reveal-group="" className="faq2_component">
                    ...
                    <div className="faq2_list">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="4f9802d4-7ba6-b178-ff3b-01803759bc91" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-4f9802d4-7ba6-b178-ff3b-01803759bc91">
                          {' '}
                        ...
                        {' '}
                        <div id="faq-answer-4f9802d4-7ba6-b178-ff3b-01803759bc91" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="4f9802d4-7ba6-b178-ff3b-01803759bc9c" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-4f9802d4-7ba6-b178-ff3b-01803759bc9c">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-4f9802d4-7ba6-b178-ff3b-01803759bc9c" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="4f9802d4-7ba6-b178-ff3b-01803759bca7" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-4f9802d4-7ba6-b178-ff3b-01803759bca7">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-4f9802d4-7ba6-b178-ff3b-01803759bca7" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="4f9802d4-7ba6-b178-ff3b-01803759bcb2" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-4f9802d4-7ba6-b178-ff3b-01803759bcb2">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-4f9802d4-7ba6-b178-ff3b-01803759bcb2" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="4f9802d4-7ba6-b178-ff3b-01803759bcbd" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-4f9802d4-7ba6-b178-ff3b-01803759bcbd">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-4f9802d4-7ba6-b178-ff3b-01803759bcbd" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                  ...
                  <div className="w-layout-grid footer3_top-wrapper">
                    ...
                    <div className="w-layout-grid footer3_menu-wrapper">
                      ...
                      <div className="footer3_link-list">
                        ...
                        {' '}
                        <a href="/soumission" aria-current="page" className="footer3_link w--current">
                          Soumission
                        </a>
                        {' '}
                      </div>
