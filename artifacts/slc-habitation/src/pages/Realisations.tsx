 ...
 * Page « /realisations ».
 *
 * Convertie depuis l'export Webflow (`site/realisations.html`) : même balisage,
...
export default function Realisations() {
  ...
  useEffect(() => {
    const container = containerRef.current;
    if (!container) return;
    return setupCategoryFilter(container);
  }, []);

  useEffect(() => {
    const container = containerRef.current;
    if (!container) return;
    return applyGalleryImageFit(container);
  }, []);
...
` }} />
            ...
            <div className="padding-global">
              ...
              <div className="banner9_content-wrapper">
                ...
                <div className="w-layout-grid banner9_social-icons">
                  {' '}
                  <a aria-label="Facebook de SLC Habitation" href="https://www.facebook.com/SLCHabitation" target="_blank" rel="noopener" className="banner9_social-link w-inline-block">
                    {' '}
          ...
          <div data-collapse="medium" data-animation="over-left" data-duration="400" fs-scrolldisable-element="smart-nav" data-easing="ease" data-easing2="ease" role="banner" className="navbar3_component color-scheme-1 w-nav">
            ...
            <div className="navbar3_container">
              ...
              <nav id="site-navigation" role="navigation" className="navbar3_menu w-nav-menu">
                ...
                {' '}
                <a href="/realisations" aria-current="page" className="navbar3_link w-nav-link w--current">
                  Réalisations
                </a>
                {' '}
                  ...
                  <div className="header50_component">
                    ...
                    <div data-reveal-group="" className="max-width-large">
                      ...
                      <p className="text-size-medium">
                        Rejoignez-nous pour donner vie à vos projets de rénovation et réaliser vos rêves d'aménagement.
                      </p>
                      {' '}
                ...
                <div className="padding-section-large">
                  ...
                  <div data-reveal-group="" className="blog22_component">
                    ...
                    <div className="blog22_content">
                      ...
                      {' '}
                      <p className="category-filter-status" data-filter-status="" aria-live="polite" />
                      {' '}
  ...
  "items": [
    {
      "url": "images/relume-655417.jpeg",
      "fileName": "relume-655417.jpeg",
      "origFileName": "relume-655417.jpeg",
      "fileSize": 0,
      "height": 0,
      "width": 0,
      "type": "image"
  ...
  "group": "gallery"
                          ...
                          <div className="blog22_item" data-category="interieur">
                            {' '}
                            <a href="/images/relume-655420.jpeg" className="blog22_item-link w-lightbox w-inline-block">
                              {' '}
                              <div className="margin-bottom margin-small">
                                {' '}
                                <div className="blog22_image-wrapper">
                                  <img sizes="(max-width: 2560px) 100vw, 2560px" srcSet="/images/relume-655420-p-500.jpeg 500w, /images/relume-655420-p-800.jpeg 800w, /images/relume-655420-p-1080.jpeg 1080w, /images/relume-655420-p-1600.jpeg 1600w, /images/relume-655420-p-2000.jpeg 2000w, /images/relume-655420.jpeg 2560w" alt="Salle de bain rénovée par SLC Habitation" loading="lazy" src="/images/relume-655420-p-800.jpeg" className="blog22_image" />
                                </div>
                                {' '}
                              </div>
                              {' '}
  ...
  "items": [
    {
      "url": "images/relume-655420.jpeg",
      "fileName": "relume-655420.jpeg",
      "origFileName": "relume-655420.jpeg",
      "fileSize": 0,
      "height": 0,
      "width": 0,
      "type": "image"
  ...
  "group": "gallery"
                          ...
                          <div className="blog22_item" data-category="interieur">
                            {' '}
                            <a href="/images/relume-655419.jpeg" className="blog22_item-link w-lightbox w-inline-block">
                              {' '}
                              <div className="margin-bottom margin-small">
                                {' '}
                                <div className="blog22_image-wrapper">
                                  <img sizes="(max-width: 1536px) 100vw, 1536px" srcSet="/images/relume-655419-p-500.jpeg 500w, /images/relume-655419-p-800.jpeg 800w, /images/relume-655419-p-1080.jpeg 1080w, /images/relume-655419.jpeg 1536w" alt="Espace de vie rénové par SLC Habitation" loading="lazy" src="/images/relume-655419-p-800.jpeg" className="blog22_image" />
                                </div>
                                {' '}
                              </div>
                              {' '}
  ...
  "items": [
    {
      "url": "images/relume-655419.jpeg",
      "fileName": "relume-655419.jpeg",
      "origFileName": "relume-655419.jpeg",
      "fileSize": 0,
      "height": 0,
      "width": 0,
      "type": "image"
  ...
  "items": [
    {
      "url": "images/relume-657406.jpeg",
      "fileName": "relume-657406.jpeg",
      "origFileName": "relume-657406.jpeg",
      "fileSize": 0,
      "height": 0,
      "width": 0,
      "type": "image"
  ...
  "group": "gallery"
                          ...
                          <div className="blog22_item" data-category="interieur">
                            {' '}
                            <a href="/images/relume-655421.jpeg" className="blog22_item-link w-lightbox w-inline-block">
                              {' '}
                              <div className="margin-bottom margin-small">
                                {' '}
                                <div className="blog22_image-wrapper">
                                  <img sizes="(max-width:
" className="blog22_item-link w-lightbox w-inline-block">
                              {' '}
                              <div className="margin-bottom margin-small">
                                {' '}
                                <div className="blog22_image-wrapper">
                                  <img sizes="(max-width: 767px) 100vw, (max-width: 991px) 50vw, 33vw" srcSet="/images/INT%C3%89RIEUR/Cuisine/20220823_074355-p-500.jpg 500w, /images/INT%C3%89RIEUR/Cuisine/20220823_074355-p-800.jpg 800w, /images/INT%C3%89RIEUR/Cuisine/20220823_074355-p-1080.jpg 1080w, /images/INT%C3%89RIEUR/Cuisine/20220823_074355-p-1600.jpg 1600w, /images/INT%C3%89RIEUR/Cuisine/20220823_074355-p-2000.jpg 2000w, /images/INT%C3%89RIEUR/Cuisine/20220823_074355.jpg 2560w" alt="Cuisine rénovée sur mesure par SLC Habitation" loading="lazy" src="/images/INT%C3%89RIEUR/Cuisine/20220823_074355-p-800.jpg" className="blog22_image" />
                                </div>
                                {' '}
                              </div>
                              {' '}
  ...
  "items": [
    {
      "url": "images/INT%C3%89RIEUR/Cuisine/20220823_074355.jpg",
      "fileName": "20220823_074355.jpg",
      "origFileName": "20220823_074355.jpg",
      "fileSize": 0,
      "height": 0,
      "width": 0,
      "type": "image"
  ...
  "group": "gallery"
                          ...
                          <div className="blog22_item" data-category="interieur">
                            {' '}
                            <a href="/images/INT%C3%89RIEUR/Cuisine/20221021_145939.jpg" className="blog22_item-link w-lightbox w-inline-block">
                              {' '}
                              <div className="margin-bottom margin-small">
                                {' '}
                                <div className="blog22_image-wrapper">
                                  <img sizes="(max-width: 767px) 100vw, (max-width: 991px) 50vw, 33vw" srcSet="/images/INT%C3%89RIEUR/Cuisine/20221021_145939-p-500.jpg 500w, /images/INT%C3%89RIEUR/Cuisine/20221021_145939-p-800.jpg 800w, /images/INT%C3%89RIEUR/Cuisine/20221021_145939-p-1080.jpg 1080w, /images/INT%C3%89RIEUR/Cuisine/20221021_145939-p-1600.jpg 1600w, /images/INT%C3%89RIEUR/Cuisine/20221021_145939-p-2000.jpg 2000w, /images/INT%C3%89RIEUR/Cuisine/20221021_145939.jpg 2560w" alt="Projet de cuisine moderne par SLC Habitation" loading="lazy" src="/images/INT%C3%89RIEUR/Cuisine/20221021_145939-p-800.jpg" className="blog22_image" />
                                </div>
                                {' '}
                              </div>
                              {' '}
  ...
  "items": [
    {
      "url": "images/INT%C3%89RIEUR/Cuisine/20221021_145939.jpg",
      "fileName": "20221021_145939.jpg",
      "origFileName": "20221021_145939.jpg",
      "fileSize": 0,
      "height": 0,
      "width": 0,
      "type": "image"
  ...
  "group": "gallery"
                          ...
                          <div className="blog22_item" data-category="interieur">
                            {' '}
                            <a href="/images/relume-567908.jpeg" className="blog22_item-link w-lightbox w-inline-block">
                              {' '}
                              <div className="margin-bottom margin-small">
                                {' '}
                                <div className="blog22_image-wrapper">
                                  <img sizes="(max-width: 1440px) 100vw, 1440px" srcSet="/images/relume-567908-p-500.jpeg 500w, /images/relume-567908-p-800.jpeg 800w, /images/relume-567908-p-1080.jpeg 1080w, /images/relume-567908.jpeg 1440w" alt="Intérieur moderne rénové par SLC Habitation" loading="lazy" src="/images/relume-567908-p-800.jpeg" className="blog22_image" />
                                </div>
                                {' '}
                              </div>
                              {' '}
  ...
  "items": [
    {
      "url": "images/relume-567908.jpeg",
      "fileName": "relume-567908.jpeg",
      "origFileName": "relume-567908.jpeg",
      "fileSize": 0,
      "height": 0,
      "width": 0,
      "type": "image"
  ...
  "group": "gallery"
                          ...
                          <div className="blog22_item" data-category="interieur">
                            {' '}
                            <a href="/images/relume-567906.jpeg" className="blog22_item-link w-lightbox w-inline-block">
                              {' '}
                              <div className="margin-bottom margin-small">
                                {' '}
                                <div className="blog22_image-wrapper">
                                  <img sizes="(max-width: 1440px) 100vw, 1440px" srcSet="/images/relume-567906-p-500.jpeg 500w, /images/relume-567906-p-800.jpeg 800w, /images/relume-567906-p-1080.jpeg 1080w, /images/relume-567906.jpeg 1440w" alt="Projet de rénovation intérieure SLC Habitation" loading="lazy" src="/images/relume-567906-p-800.jpeg" className="blog22_image" />
                                </div>
                                {' '}
                              </div>
                              {' '}
  ...
  "items": [
    {
      "url": "images/relume-567906.jpeg",
      "fileName": "relume-567906.jpeg",
      "origFileName": "relume-567906.jpeg",
      "fileSize": 0,
      "height": 0,
      "width": 0,
      "type": "image"
  ...
  "group": "gallery"
                          ...
                          {' '}
                          {' '}
                          <div className="blog22_item" data-category="commercial">
                            {' '}
                            <a href="/images/COMMERCIAL/20170517_124025.jpg" className="blog22_item-link w-lightbox w-inline-block">
                              {' '}
                              <div className="margin-bottom margin-small">
                                {' '}
                                <div className="blog22_image-wrapper">
                                  <img sizes="(max-width: 767px) 100vw, (max-width: 991px) 50vw, 33vw" srcSet="/images/COMMERCIAL/20170517_124025-p-500.jpg 500w, /images/COMMERCIAL/20170517_124025-p-800.jpg 800w, /images/COMMERCIAL/20170517_124025-p-1080.jpg 1080w, /images/COMMERCIAL/20170517_124025-p-1600.jpg 1600w, /images/COMMERCIAL/20170517_124025-p-2000.jpg 2000w, /images/COMMERCIAL/20170517_124025.jpg 2560w" alt="Aménagement commercial réalisé par SLC Habitation" loading="lazy" src="/images/COMMERCIAL/20170517_124025.jpg" className="blog22_image" />
                                </div>
                                {' '}
                              </div>
                              {' '}
  ...
  "items": [
    {
      "url": "images/COMMERCIAL/20170517_124025.jpg",
      "fileName": "20170517_124025.jpg",
      "origFileName": "20170517_124025.jpg",
      "fileSize": 0,
      "height": 0,
      "width": 0,
      "type": "image"
  ...
  "group": "gallery"
                          ...
                          <div className="blog22_item" data-category="commercial">
                            {' '}
                            <a href="/images/COMMERCIAL/20170517_124129.jpg" className="blog22_item-link w-lightbox w-inline-block">
                              {' '}
                              <div className="margin-bottom margin-small">
                                {' '}
                                <div className="blog22_image-wrapper">
                                  <img sizes="(max-width: 767px) 100vw, (max-width: 991px) 50vw, 33vw" srcSet="/images/COMMERCIAL/20170517_124129-p-500.jpg 500w, /images/COMMERCIAL/20170517_124129-p-800.jpg 800w, /images/COMMERCIAL/20170517_124129-p-1080.jpg 1080w, /images/COMMERCIAL/20170517_124129-p-1600.jpg 1600w, /images/COMMERCIAL/20170517_124129-p-2000.jpg 2000w, /images/COMMERCIAL/20170517_124129.jpg 2560w" alt="Projet de rénovation commerciale par SLC Habitation" loading="lazy" src="/images/COMMERCIAL/20170517_124129.jpg" className="blog22_image" />
                                </div>
                                {' '}
                              </div>
                              {' '}
  ...
  "items": [
    {
      "url": "images/COMMERCIAL/20170517_124129.jpg",
      "fileName": "20170517_124129.jpg",
      "origFileName": "20170517_124129.jpg",
      "fileSize": 0,
      "height": 0,
      "width": 0,
      "type": "image"
  ...
  "group": "gallery"
                  ...
                  <div data-reveal-group="" className="faq2_component">
                    ...
                    <div className="faq2_list">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="361cc79c-1027-0ac5-845d-6c55925cae38" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-361cc79c-1027-0ac5-845d-6c55925cae38">
                          {' '}
                        ...
                        {' '}
                        <div id="faq-answer-361cc79c-1027-0ac5-845d-6c55925cae38" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="361cc79c-1027-0ac5-845d-6c55925cae43" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-361cc79c-1027-0ac5-845d-6c55925cae43">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-361cc79c-1027-0ac5-845d-6c55925cae43" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="361cc79c-1027-0ac5-845d-6c55925cae4e" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-361cc79c-1027-0ac5-845d-6c55925cae4e">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-361cc79c-1027-0ac5-845d-6c55925cae4e" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="361cc79c-1027-0ac5-845d-6c55925cae59" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-361cc79c-1027-0ac5-845d-6c55925cae59">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-361cc79c-1027-0ac5-845d-6c55925cae59" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="361cc79c-1027-0ac5-845d-6c55925cae64" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-361cc79c-1027-0ac5-845d-6c55925cae64">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-361cc79c-1027-0ac5-845d-6c55925cae64" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                  ...
                  <div className="w-layout-grid footer3_top-wrapper">
                    ...
                    <div className="footer3_left-wrapper">
                      ...
                      <div className="w-layout-grid footer3_social-list">
                        {' '}
                        <a aria-label="Facebook de SLC Habitation" href="https://www.facebook.com/SLCHabitation" target="_blank" rel="noopener" className="footer3_social-link w-inline-block">
                          {' '}
                          <div className="icon-embed-xsmall w-embed">
                    ...
                    <div className="w-layout-grid footer3_menu-wrapper">
                      ...
                      <div className="footer3_link-list">
                        ...
                        {' '}
                        <a href="/realisations" aria-current="page" className="footer3_link w--current">
                          Réalisations
                        </a>
                        {' '}
      ...
      <div data-back-to-top="wrap" className="back-top__wrap">
        {' '}
        <a aria-label="Contacter SLC Habitation sur Messenger" href="https://www.facebook.com/SLCHabitation" target="_blank" rel="noopener" className="messenger_button w-inline-block">
