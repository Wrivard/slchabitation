...
/**
 * Page « /travaux-sur-mesure ».
 *
 * Convertie depuis l'export Webflow (`site/travaux-sur-mesure.html`) : même balisage,
 * mêmes classes, mêmes textes, écrits en composants React plutôt qu'injectés
 * comme un bloc de HTML.
 */
export default function TravauxSurMesure() {
              ...
              <nav id="site-navigation" role="navigation" className="navbar3_menu w-nav-menu">
                ...
                <div data-delay="200" data-hover="true" className="navbar3_menu-dropdown w-dropdown">
                  ...
                  <nav className="navbar3_dropdown-list w-dropdown-list">
                    ...
                    {' '}
                    <a href="/travaux-sur-mesure" aria-current="page" className="navbar3_dropdown-link w-dropdown-link w--current">
                      Travaux sur mesure
                    </a>
                    {' '}
                  </nav>
                  ...
                  <div className="header50_component">
                    ...
                    <div data-reveal-group="" className="max-width-large">
                      ...
                      <p className="text-size-medium">
                        Réparations et entretien spécialisé pour préserver la valeur de votre propriété
                      </p>
                      {' '}
                  ...
                  <div className="layout201_component">
                    ...
                    <div data-reveal-group="" className="w-layout-grid layout201_content">
                      ...
                      <div className="layout201_image-wrapper">
                        <img sizes="(max-width: 960px) 100vw, 960px" srcSet="/images/relume-655436-p-500.jpeg 500w, /images/relume-655436-p-800.jpeg 800w, /images/relume-655436.jpeg 960w" alt="Réparation résidentielle sur mesure par SLC Habitation" src="/images/relume-655436.jpeg" loading="lazy" className="layout201_image" />
                      </div>
                      {' '}
                      <div id="w-node-e5b96cda-bccb-eaa7-0940-485899c96565-47df6b95" className="layout201_content-right">
                        {' '}
                        <div className="margin-bottom margin-xsmall">
                          {' '}
                        ...
                        <div className="margin-bottom margin-medium">
                          {' '}
                          <p className="text-size-medium">
                            Chaque maison a ses propres défis. Nous diagnostiquons le problème réel, puis nous agissons avec la méthode qui convient. Pas de formules génériques, seulement du travail adapté à votre situation.
                          </p>
                          {' '}
                        </div>
                        {' '}
                        <div className="w-layout-grid layout201_item-list">
                          ...
                          <div className="layout201_item">
                            ...
                            {' '}
                            <p>
                              Nous examinons chaque détail pour comprendre ce qui doit être fait.
                            </p>
                            {' '}
                          </div>
                          {' '}
                          <div className="layout201_item">
                            ...
                            {' '}
                            <p>
                              Les réparations que nous faisons tiennent bon. C'est du travail qui dure.
                            </p>
                            {' '}
                          </div>
                          {' '}
                      ...
                      <div data-reveal-group="" className="w-layout-grid layout356_content-layout">
                        ...
                        <div className="layout356_content-left">
                          ...
                          <div className="margin-bottom margin-small">
                            {' '}
                            <h2 className="heading-style-h2">
                              <span className="text-span-16">
                                Transformez
                              </span>
                              {' vos espaces de vie au quotidien'}
                            </h2>
                            {' '}
                          </div>
                          {' '}
                          <p className="text-size-medium">
                            Cuisines, salles de bains, sous-sols. Nous rénovons chaque pièce avec attention aux détails et respect de votre vision. Les matériaux choisis durent, et le travail parle de lui-même.
                          </p>
                          {' '}
                          <div className="margin-top margin-medium">
                            {' '}
                    ...
                    <div className="padding-vertical padding-large">
                      ...
                      <div data-reveal-group="" className="w-layout-grid layout356_content-layout">
                        ...
                        <div className="layout356_content-left">
                          ...
                          {' '}
                          <p className="text-size-medium">
                            Toitures, revêtements, portes et fenêtres. Nos réparations et installations extérieures résistent aux saisons. Chaque élément est installé pour durer des années.
                          </p>
                          {' '}
                          <div className="margin-top margin-medium">
                            {' '}
                        ...
                        {' '}
                        <div className="layout356_image-wrapper">
                          <img sizes="(max-width: 1184px) 100vw, 1184px" srcSet="/images/relume-655438-p-500.png 500w, /images/relume-655438-p-800.png 800w, /images/relume-655438-p-1080.png 1080w, /images/relume-655438.png 1184w" alt="Travaux extérieurs sur mesure par SLC Habitation" src="/images/relume-655438.png" loading="lazy" className="layout356_image" />
                        </div>
                        {' '}
                      </div>
                      {' '}
                        ...
                        <div className="layout356_content-left">
                          ...
                          <div className="margin-bottom margin-small">
                            ...
                            <h2 className="heading-style-h2">
                              ...
                              {' la base solide de votre demeure'}
                            </h2>
                            {' '}
                          </div>
                          {' '}
                          <p className="text-size-medium">
                            Réparations de plancher, planchers flottants, travaux de fondation. Nous traitons les problèmes à la racine avec des solutions durables et fiables.
                          </p>
                          {' '}
                          <div className="margin-top margin-medium">
                            {' '}
                  ...
                  <div className="layout203_component">
                    ...
                    <div data-reveal-group="" className="w-layout-grid layout203_content">
                      ...
                      <div className="layout203_image-wrapper">
                        <img sizes="(max-width: 1440px) 100vw, 1440px" srcSet="/images/relume-567908-p-500.jpeg 500w, /images/relume-567908-p-800.jpeg 800w, /images/relume-567908-p-1080.jpeg 1080w, /images/relume-567908.jpeg 1440w" alt="Travaux de rénovation sur mesure par SLC Habitation" src="/images/relume-567908.jpeg" loading="lazy" className="layout203_image" />
                      </div>
                      {' '}
                      <div id="w-node-e5b96cda-bccb-eaa7-0940-485899c965eb-47df6b95" className="layout203_content-right">
                        {' '}
                        <div className="margin-bottom margin-small">
                          {' '}
                        ...
                        <div className="w-layout-grid layout203_item-list">
                          ...
                          <div className="layout203_item">
                            ...
                            {' '}
                            <p>
                              Deux décennies et demie de projets réussis dans la région.
                            </p>
                            {' '}
                          </div>
                          {' '}
                          <div className="layout203_item">
                            ...
                            {' '}
                            <p>
                              Nous disons ce que nous faisons et nous le faisons bien.
                            </p>
                            {' '}
                          </div>
                          {' '}
  ...
  "items": [
    {
      ...
      "width": 0,
      "type": "image",
      "caption": "Rénovation intérieure sur mesure par SLC Habitation"
    }
  ],
  "group": "portfolio-travaux-sur-mesure"
}` }} />
                        {' '}
                      </a>
                      {' '}
  ...
  "items": [
    {
      ...
      "width": 0,
      "type": "image",
      "caption": "Travaux de rénovation sur mesure par SLC Habitation"
    }
  ],
  "group": "portfolio-travaux-sur-mesure"
}` }} />
                  ...
                  <div data-reveal-group="" className="faq2_component">
                    ...
                    <div className="faq2_list">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="e5b96cda-bccb-eaa7-0940-485899c966a2" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-e5b96cda-bccb-eaa7-0940-485899c966a2">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-e5b96cda-bccb-eaa7-0940-485899c966a2" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="e5b96cda-bccb-eaa7-0940-485899c966ad" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-e5b96cda-bccb-eaa7-0940-485899c966ad">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-e5b96cda-bccb-eaa7-0940-485899c966ad" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="e5b96cda-bccb-eaa7-0940-485899c966b8" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-e5b96cda-bccb-eaa7-0940-485899c966b8">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-e5b96cda-bccb-eaa7-0940-485899c966b8" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="e5b96cda-bccb-eaa7-0940-485899c966c3" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-e5b96cda-bccb-eaa7-0940-485899c966c3">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-e5b96cda-bccb-eaa7-0940-485899c966c3" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                      ...
                      <div className="faq2_accordion">
                        {' '}
                        <button type="button" data-w-id="e5b96cda-bccb-eaa7-0940-485899c966ce" className="faq2_question" aria-expanded="false" aria-controls="faq-answer-e5b96cda-bccb-eaa7-0940-485899c966ce">
                          {' '}
                          <div className="text-size-medium">
                        ...
                        {' '}
                        <div id="faq-answer-e5b96cda-bccb-eaa7-0940-485899c966ce" style={{ width: '100%', height: '0px' }} className="faq2_answer" aria-hidden="true">
                          {' '}
                          <div className="margin-bottom margin-small">
                            {' '}
                            <div className="max-width-large">
                  ...
                  <div className="w-layout-grid footer3_top-wrapper">
                    ...
                    <div className="w-layout-grid footer3_menu-wrapper">
                      ...
                      <div className="footer3_link-list">
                        ...
                        {' '}
                        <a href="/travaux-sur-mesure" aria-current="page" className="footer3_link w--current">
                          Travaux sur mesure
                        </a>
                        {' '}
                      </div>
