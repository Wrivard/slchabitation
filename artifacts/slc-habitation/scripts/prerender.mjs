...
const paidPageEnhancements = {
  'renovation-cuisine': {
    ...
    images: [
      ...
      ['/images/INT%C3%89RIEUR/Cuisine/20220823_074355-p-1600.jpg', 'Cuisine élégante avec finitions soignées', 1600, 1200],
      ['/images/INT%C3%89RIEUR/Cuisine/2403-p-1080.jpg', 'Détail de cuisine et éclairage', 1080, 1440],
      ['/images/relume-567906.jpeg', 'Cuisine moderne ouverte avec îlot', 1440, 1440],
      ['/images/INT%C3%89RIEUR/Cuisine/12509173_866265596824275_1393287164403664650_n%20(1).jpg', 'Cuisine classique avec boiseries', 510, 561],
    ],
  ...
  'renovation-salle-de-bain': {
    ...
    images: [
      ...
      ['/images/INT%C3%89RIEUR/Salle%20de%20Bain/20240709_151409-p-1600.jpg', 'Bain autoportant et détails', 1600, 1200],
      ['/images/INT%C3%89RIEUR/Salle%20de%20Bain/20220511_145711-p-1600.jpg', 'Salle de bain moderne', 1600, 2133],
      ['/images/INT%C3%89RIEUR/Salle%20de%20Bain/20241030_163652-p-1600.jpg', 'Détail salle de bain lumineuse', 1600, 1200],
    ],
  ...
  'renovation-sous-sol': {
    ...
    images: [
      ...
      ['/images/INT%C3%89RIEUR/randoms/20240926_155408-p-1600.jpg', 'Vue rapprochée du sous-sol avant le réaménagement', 1600, 1200],
      ['/images/INT%C3%89RIEUR/randoms/20241017_152123-p-1600.jpg', 'Vue complémentaire du sous-sol avec plancher clair et fenêtres basses', 1600, 1200],
      ['/images/INT%C3%89RIEUR/randoms/20241018_161142-p-1600.jpg', 'Vue complémentaire de la pièce polyvalente au sous-sol', 1600, 1200],
    ],
...
function createPaidStaticBody(content, routePath) {
  ...
  <section class="bg-secondary py-20 text-white text-center"><div class="container-large mx-auto max-w-4xl px-6"><h2>Parlons de votre projet</h2><p class="mb-8">Décrivez-nous votre espace actuel et ce que vous voulez changer. Nous vous répondons sous 48 heures et la visite d’évaluation est sans frais.</p>${cta}</div></section></main>
