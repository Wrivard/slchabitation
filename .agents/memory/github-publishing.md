...
**La connexion elle-même peut mourir.** Quand l'API répond « Connection is disconnected: Token validation failed with status 401 », plus rien ne passe, même en lecture, et lier de nouveau la connexion ne la répare pas. La carte de reconnexion n'est pas toujours proposable : l'identifiant de connexion peut rester visible à la recherche tout en étant introuvable pour la proposition. Dans ce cas, aucun chemin automatique n'existe — demander à l'utilisateur de rétablir la connexion depuis le panneau Integrations, ou de pousser lui-même. Ne jamais demander de jeton.
